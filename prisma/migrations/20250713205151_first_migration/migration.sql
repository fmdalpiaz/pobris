...
-- AddForeignKey
ALTER TABLE "transaction_items" ADD CONSTRAINT "transaction_items_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
